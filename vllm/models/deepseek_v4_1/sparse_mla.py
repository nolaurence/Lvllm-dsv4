...
class DeepseekV4SparseMLABackend(AttentionBackend):
    ...
    def supports_compute_capability(cls, capability: DeviceCapability) -> bool:
        # SM86 uses the reference/Triton fallback selected by the V4.1
        # FlashMLA attention implementation.  The fused FlashMLA kernels still
        # require SM90+, but keeping SM86 in the model backend capability lets
        # the model reach that fallback instead of being rejected at startup.
